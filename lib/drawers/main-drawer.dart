    ...
    return Container(
        ...
        child: ListView(padding: EdgeInsets.zero, children: <Widget>[
          ...
          ListTile(
              ...
              title:
                  Text(getTranslated(context, 'home_page'), style: _textStyle),
              onTap: () {
                Navigator.pop(context);
                Navigator.pushNamed(context, homeRoute);
              }),
          ListTile(
              ...
              title: Text(getTranslated(context, 'aboutus'), style: _textStyle),
              onTap: () {
                Navigator.pop(context);
          ...
          ListTile(
              ...
              title: Text(getTranslated(context, 'gallery'), style: _textStyle),
              onTap: () {
                Navigator.pop(context);
          ...
          ListTile(
              ...
              title: Text(getTranslated(context, 'Videos'), style: _textStyle),
              onTap: () {
                Navigator.pop(context);
          ...
          ListTile(
              ...
              title:
                  Text(getTranslated(context, 'teamwork'), style: _textStyle),
              onTap: () {
                Navigator.pop(context);
          ...
          ListTile(
              ...
              title: Text(getTranslated(context, 'consultations'),
                  style: _textStyle),
              onTap: () {
                Navigator.pop(context);
                if (userID != null && userID != "null") {
          ...
          ListTile(
              ...
              title:
                  Text(getTranslated(context, 'contact_us'), style: _textStyle),
              onTap: () {
                Navigator.pop(context);
          ...
          ListTile(
              ...
              title: Text(getTranslated(context, 'faqs'), style: _textStyle),
              onTap: () {
                Navigator.pop(context);
          ...
          ListTile(
              ...
              title:
                  Text(getTranslated(context, 'book_now'), style: _textStyle),
              onTap: () {
                Navigator.pop(context);
                if (userID != null && userID != "null") {
          ...
          ListTile(
              ...
              title:
                  Text(getTranslated(context, 'other_lang'), style: _textStyle),
              onTap: () {
