...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> getLoggeInUser() async {
    ...
    var response = await http.post(Utils.ProfileData_URL, body: {
      'user_id': userID,
    });
  ...
  _uploadData() async {
    try {
      var response = await http.post(Utils.Profile_URL, body: {
        'user_id': userID,
        'name': _name.text,
        'email': _email.text,
        'mobile': _phone.text,
      ...
      setState(() async {
        ...
        if (map['status'] == 'success') {
          ...
          _handleClickMe(
              getTranslated(context, 'Profile-updated-successfuly-message'));
        }
      });
      // Navigator.pop(context);
    } catch (e) {
