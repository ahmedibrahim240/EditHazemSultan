...
// import '../models/Profile-result.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void>getLoggeInUser()async {
    SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
      ...
      var response = await http.post(Utils.ProfileData_URL,
                                  body: {
                                      'user_id'    : userID,
                                  });
      Map<String, dynamic> map = json.decode(response.body);

      _name.text = map['data']['name'];
      _email.text = map['data']['email'];
      _phone.text = map['data']['Phone'];
  }

  _uploadData() async{
    try {
      var response = await http.post(Utils.Profile_URL,
                                  body: {
                                      'user_id' : userID,
                                      'name'    : _name.text,
                                      'email'   : _email.text,
      ...
      setState(() async {
        ...
        if (map['status'] == 'success') {
          ...
          _handleClickMe(getTranslated(context, 'Profile-updated-successfuly-message'));
        }
      });
      // Navigator.pop(context);
    } catch (e) {
