                ...
                if (snapshot.connectionState == ConnectionState.done) {
                  ...
                  return ListView(
                          children: <Widget>[
                                  ...
                                  Expanded(
                                    child: Container(
                                      ...
                                      child: GestureDetector(
                                              onTap: () async{
                                                var _phoneURL = "tel:${homeData[0]['LandLine']}";
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: Container(
                                      ...
                                      child: GestureDetector(
                                              onTap: () async{
                                                var _whatsAppURL = "mailto:${homeData[0]['email']}";
                            ...
                            : Container(),
                            (homeData[0]['CellPhone'] != null && homeData[0]['CellPhone'] != "") ?
                              Row(
                                children: <Widget>[
                                  Container(
                                    padding: EdgeInsets.all(6),
                                  ...
                                  Expanded(
                                    child: Container(
                                      ...
                                      child: GestureDetector(
                                              onTap: () async{
                                                var _phoneURL = "tel:${homeData[0]['CellPhone']}";
                                                if (await canLaunch(_phoneURL)) {
                                                  launch(_phoneURL);
                                                }
                                              },
                                ...
                                children: <Widget>[
                                  ...
                                  Expanded(
                                    child: Container(
                                      ...
                                      child: GestureDetector(
                                              onTap: () async{
                                                var _whatsAppURL = "https://wa.me/${homeData[0]['whatsApp']}";
                                                if (await canLaunch(_whatsAppURL)) {
                                                  launch(_whatsAppURL);
                                                }
                                              },
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                (homeData[0]['facebook'] != null && homeData[0]['facebook'] != "") ?
                                  Container(
                                    margin: EdgeInsets.all(5),
                                    decoration: BoxDecoration(
                                ...
                                :
                                  Container(),
                                (homeData[0]['twitter'] != null && homeData[0]['twitter'] != "") ?
                                  Container(
                                    margin: EdgeInsets.all(5),
                                    decoration: BoxDecoration(
                                ...
                                :
                                  Container(),
                                (homeData[0]['youtube'] != null && homeData[0]['youtube'] != "") ?
                                  Container(
                                    margin: EdgeInsets.all(5),
                                    decoration: BoxDecoration(
                                ...
                                :
                                  Container(),
                                (homeData[0]['linkedin'] != null && homeData[0]['linkedin'] != "") ?
                                  Container(
                                    margin: EdgeInsets.all(5),
                                    decoration: BoxDecoration(
                                ...
                                :
                                  Container(),
                                (homeData[0]['instagram'] != null && homeData[0]['instagram'] != "") ?
                                  Container(
                                    margin: EdgeInsets.all(5),
                                    decoration: BoxDecoration(
