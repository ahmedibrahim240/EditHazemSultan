...
class _TeamWorkPageState extends State<TeamWorkPage> {
  ...
  _getTeamWork() async {
    try {
      var response = await http.post(Utils.TEAMWORL_URL, body: {'lang': 'ar'});
                      ...
                      Container(
                        ...
                        child: Column(
                            ...
                            children: <Widget>[
                              ...
                              (teamMembers[index]['info_' +
                                          getTranslated(
                                              context, 'this_lang_code')] !=
                                      null)
                                  ? Text(
                                      teamMembers[index]['info_' +
                                          getTranslated(
                      ...
                      Expanded(
                        child: Center(
                          child: Container(
                              ...
                              child: CircleAvatar(
                                  backgroundImage: (teamMembers[index]
                                              ['file'] !=
                                          null)
                                      ? NetworkImage(teamMembers[index]['file'])
                                      : AssetImage(
                                          'lib/assets/images/hazem.png'))),
                        ),
                      )
                    ]),
                  );
